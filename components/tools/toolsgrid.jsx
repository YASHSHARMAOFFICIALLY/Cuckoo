...
//     <div
//       ref={ref}
//       className="group p-7 rounded-2xl border border-[#E8E8E8] bg-white hover:border-[#D0D0D0] hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] transition-all duration-200 cursor-pointer flex flex-col"
//     >
//       <div className="flex items-start justify-between mb-5">
//         <div className="w-11 h-11 rounded-xl bg-[#F8F8F6] border border-[#F0F0F0] flex items-center justify-center group-hover:bg-[#F5F1E8] transition-colors duration-200">
//           {tool.icon}
//         </div>
//         <span className="text-[11px] font-medium px-2.5 py-1 rounded-full" style={tool.tagStyle}>{tool.tag}</span>
//       </div>
//       <h3 className="text-[16px] font-semibold text-[#0F0F0F] tracking-[-0.02em] mb-2">{tool.name}</h3>
//       <p className="text-[13.5px] text-[#777] leading-relaxed tracking-[-0.01em] flex-1">{tool.desc}</p>
//       <a
//         href={tool.href}
//         className="mt-6 inline-flex items-center gap-1.5 text-[13px] font-medium text-[#0F0F0F] bg-[#F8F8F6] border border-[#EBEBEB] px-4 py-2 rounded-lg hover:bg-[#0F0F0F] hover:text-white hover:border-[#0F0F0F] transition-all duration-200 self-start"
//       >
//         Open Tool
...
//   return (
//     <section id="tools-grid" className="py-16 px-6 bg-[#FAFAF8]">
...
//               <span className="text-[12px] text-[#666] font-medium tracking-wide">All Tools</span>
//             </div>
//             <h2 className="text-[30px] font-semibold tracking-[-0.03em] text-[#0F0F0F]" style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}>
//               Pick a tool to get started
//             </h2>
//           </div>
//           <p className="text-[14px] text-[#888] max-w-xs leading-relaxed">4 calculators. All free. No sign-up required.</p>
//         </div>
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
//           {tools.map((t, i) => <ToolCard key={t.id} tool={t} delay={i * 70} />)}
//         </div>
//       </div>
//     </section>
//   );
