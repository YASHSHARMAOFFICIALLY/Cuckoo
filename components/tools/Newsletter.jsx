  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F5F5F3] border border-[#E8E8E8] mb-6">
        ...
        <p className="text-[15.5px] text-[#666] leading-relaxed mb-10 tracking-[-0.01em]">
          Get weekly tips on investing, saving, and building financial intelligence — straight to your inbox.
        </p>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <div className={`flex-1 flex items-center gap-3 px-4 py-3 rounded-xl border bg-white transition-all duration-200 ${focused ? "border-[#0F0F0F] shadow-[0_0_0_3px_rgba(15,15,15,0.06)]" : "border-[#E0E0E0]"}`}>
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-[#0F0F0F] text-white text-[13.5px] font-medium rounded-xl hover:bg-[#2a2a2a] transition-all duration-200 tracking-[-0.01em] whitespace-nowrap shadow-sm"
            >
              Subscribe
            </button>
          </form>
        ...
        <p className="mt-5 text-[12px] text-[#BBB]">No spam. Unsubscribe any time. Free forever.</p>

        {/* Social proof */}
        <div className="mt-10 flex items-center justify-center gap-6 flex-wrap text-[12.5px] text-[#888]">
          {["Weekly cadence", "No promotions", "Finance experts only"].map((item, i) => (
